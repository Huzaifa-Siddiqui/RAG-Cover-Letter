...
export function R2Form() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/knowledge/r2", {
        method: "POST",
        headers: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        <Label htmlFor="r2-project-title" className="text-gray-300 text-sm">Project Title</Label>
        <Input
          id="r2-project-title"
      ...
      <div className="space-y-2">
        <Label htmlFor="r2-project-description" className="text-gray-300 text-sm">Project Description</Label>
        <Textarea
